...
private:
    ...
    static pthread_mutex_t mtx_setInet;
...
pthread_mutex_t Address::mtx_setInet = PTHREAD_MUTEX_INITIALIZER;
...
{   
    pthread_mutex_lock(&mtx_setInet);
    this->ip = strdup(inet_ntoa(address.sin_addr));
    pthread_mutex_unlock(&mtx_setInet);
